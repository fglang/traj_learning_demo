...
|---|---|---|---|
| [SPARKLING](https://dx.doi.org/10.1002/mrm.27678) | 2019 | upon request | optimized for CS reco, fixed target sampling density, model-driven, no training data |
| [3D-SPARKLING](https://dx.doi.org/10.1002/nbm.4349) | 2020 | upon request | stack-of-SPARKLING & full 3D |
| [PROJeCTOR](https://dx.doi.org/10.3390/bioengineering10020158) | 2023 | upon request | similar to SPARKLING, data-driven learning of trajectory & reco |
